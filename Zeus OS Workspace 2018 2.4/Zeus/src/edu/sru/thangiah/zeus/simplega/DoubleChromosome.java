...
//   protected sGA parent;


   protected DoubleChromosome(String file, sGA parent) { // construction only by subclasses
      super(file,parent);
      this.file = file;
      this.parent = parent;
   ...
   public Chromosome cloneChromosome() {
      MyChromosome theClone = new MyChromosome(file,parent);
